...
- *English*, *Russian* (defaults) — by [Alexander Krutov](https://github.com/AlexanderKrutov)
- *French* — by [Thierry Jouve](https://github.com/Zerog1972)

If you want to translate Astrarium to a language not listed above, please create an issue or PR on [GitHub](https://github.com/Astrarium/Astrarium)
...
- **Other icons**  
are mostly from [Noun Project](https://thenounproject.com/)
by miscellanous authors
licensed under Creative Commons CCBY license
